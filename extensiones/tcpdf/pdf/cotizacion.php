...
$bloque1 = <<<EOF
	...
	<table cellspacing="0" style="width: 100%;">
		...
		<tr>
			...
			<td style="width:150px"><img src="images/logo_ferreteria.jpeg"></td>
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:0px 10px;">
		 ...
		 <tr>
           <td style="width: 50%; background-color:#2c3e50; padding: 4px 4px 4px; font-weight:bold;  color:white;">CLIENTE
           </td>
		...
		<tr>
			...
			<td >
				Identificación: $respuestaCliente[documento]
				<br>
...
$bloque5 = <<<EOF
	...
	<br>
	<div style="font-size:9pt;text-align:center;font-weight:bold">Recuerda que contamos con servicio a domicilio y gran variedad de productos</div>
