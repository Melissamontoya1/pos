...
$cliente_provicional=$respuestaVenta["cliente_provicional"];
...
$bloque1 = <<<EOF
	...
	<table cellspacing="0" style="width: 100%;">
		...
		<tr>
			...
			<td style="background-color:white; width:110px; text-align:center; color:red" font-weight:bold><br>CTA COBRO N.<br>$codigo</td>
	...
	<table style="font-size:10px; padding:0px 10px;">
		...
		<tr>
			...
			<td>
				...
				Cliente: $respuestaVenta[cliente_provicional]
				<br>
				Direccion: $respuestaCliente[direccion]
				<br>
				Telefono: $respuestaCliente[telefono]
