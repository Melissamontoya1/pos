...
class ModeloProductos{
	...
	static public function mdlMostrarTProductos($tabla){
	...
	static public function mdlMostrarStockProductos(){

		

		$stmt = Conexion::conectar()->prepare("SELECT * FROM productos WHERE stock<15 ORDER BY descripcion ASC");
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, codigo, descripcion, stock, precio_compra, precio_venta,iva_producto,proveedor) VALUES (:id_categoria, :codigo, :descripcion, :stock, :precio_compra, :precio_venta,:iva_producto,:proveedor)");
	...
	static public function mdlEditarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET codigo=:codigo,id_categoria = :id_categoria, descripcion = :descripcion, stock = :stock, precio_compra = :precio_compra, precio_venta = :precio_venta, iva_producto = :iva_producto, proveedor =:proveedor WHERE id = :id");
	...
	static public function mdlSumaPrecioCompra($tabla){
	...
	static public function mdlSumaPrecioVenta($tabla){
