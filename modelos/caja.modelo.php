...
class ModeloCaja{
	...
	static public function mdlCerrarCaja($datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE caja SET fecha_cierre = :fecha_cierre
			...
			, recuento_efectivo = :recuento_efectivo
		...
		$stmt->bindParam(":diferencia", $datos["diferencia"], PDO::PARAM_STR);
		$stmt->bindParam(":observaciones", $datos["observaciones"], PDO::PARAM_STR);
		$stmt->bindParam(":total_gastos", $datos["total_gastos"], PDO::PARAM_STR);
		$stmt->bindParam(":total_final", $datos["total_final"], PDO::PARAM_STR);
		$stmt->bindParam(":recuento_efectivo", $datos["recuento_efectivo"], PDO::PARAM_STR);
