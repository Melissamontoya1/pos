...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="col-md-12 pt-3">
      <center>
        <form action="" method="POST" class="form-reporteP form-inline col-md-12">
          <label for="">Codigo Producto</label>
         <input list="browsers" id="codigo" name="codigo"  class="form-control select2 input-sm codigo" required />
         <datalist id="browsers">
          <?php
          $productos = ControladorProductos::ctrMostrarTProductos();
       ...
       <input type="date" class="form-control fechaInicial" name="fechaInicial" required >
       <label for="">Fecha Fin</label>
       <input type="date" class="form-control fechaFinal" name="fechaFinal" required>
       <select name="tipo_reporte" id="" class="form-control tipo_reporte" required>
        <option value="PDF">PDF</option>
      </select>
      <button class="btn btn-info reporteP" type="submit" name="">Generar Reporte</button>
    </form>
  </center>
</div>
<div hidden>
...
<div class="box-body">
 ...
 <table class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tablaVentas" name="tablaVentas" >
 ...
 <tbody>
  ...
  foreach ($respuesta as $key => $value) {
   ...
   <td>'.number_format($value["cantidadProducto"]).'</td>

   <td>'.number_format($value["precioProducto"]).'</td>

   <td>$ '.number_format($value["totalProducto"]).'</td>
...
$(".reporteP").on("click",  function () {
var codigo = $(".codigo").val();
  var fechaInicial = $(".fechaInicial").val();
  var fechaFinal = $(".fechaFinal").val();
  var tipo_reporte = $(".tipo_reporte").val();
  //alert(fechaFinal+ fechaInicial+tipo_reporte);
  window.open("vistas/modulos/reporte-utilidad.php?codigo="+codigo+"&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal+"&tipo_reporte="+tipo_reporte,"_blank");
})
</script>
