  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive AdministrarVentas" width="100%" id="tablaVentas" name="tablaVentas" >
...
<div id="btnproductos" class="modal fade btnproductos"  role="dialog">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <!--=====================================
                ...
                <input type="hidden" class="form-control" id="nuevoCaja" name="nuevoCaja" value="<?php echo $cajaAbierta["id"]; ?>" readonly>
...
/*=============================================
 ...
 $(".AdministrarVentas").on("click", ".btnproductos", function(){
 ...
 function cargaproductos(UUID = '0',)
 {
    //alert(UUID);
   var dataTable = $('.tablaProductos').DataTable({
    ...
    "ajax" : {
     url:"ajax/datatable-facturap-ajax.php",
     type:"POST",
