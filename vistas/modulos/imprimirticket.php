...
$printer -> text("--------------------------------");
				...
				if($venta["cliente_provicional"]==""){
					$printer -> text("Cliente: ".$traerCliente["nombre"]."\n");//Nombre del cliente
				}else{
					$printer -> text("Cliente: ".$venta["cliente_provicional"]."\n");//Nombre del cliente
				}
				...
				foreach ($pagos as $keyp => $valuep) {
					...
					$printer->text("Recibido $ : ".$valuep["importePagado"]."\n");//Nombre del producto
              	$printer->text("Devuelta $ : ".$valuep["importeDevuelto"]."\n");//Nombre del producto
              	$printer -> text("--------------------------------");
