...
class ControladorProductos{
	...
	static public function ctrMostrarTProductos(){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlMostrarTProductos($tabla);

		return $respuesta;

	}
		static public function ctrMostrarStockProductos(){

		$tabla = "productos";
		$item="10";

		$respuesta = ModeloProductos::mdlMostrarStockProductos($tabla,$item);
	...
	static public function ctrCrearProducto(){
		...
		if(isset($_POST["nuevaDescripcion"])){
			...
			if(preg_match("/^[a-zA-Z0-9.ñÑáéíóúÁÉÍÓÚ ]+(?:-|'|\/[a-zA-Z0-9.ñÑáéíóúÁÉÍÓÚ]+)*$/", $_POST["nuevaDescripcion"]) &&
 ...
 /* =============================================
      ...
      static public function ctrPrecioCompra() {

      	$tabla = "productos";

      	$respuesta = ModeloProductos::mdlSumaPrecioCompra($tabla);
      ...
      static public function ctrPrecioVenta() {

      	$tabla = "productos";

      	$respuesta = ModeloProductos::mdlSumaPrecioVenta($tabla);
