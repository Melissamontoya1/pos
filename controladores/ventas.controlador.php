...
class ControladorVentas {
      ...
      static public function ctrCrearVenta() {
        ...
        if (isset($_POST["nuevaVenta"])) {
            ...
            /* =============================================
              ...
              $importePagado = $_POST["totalVenta"];
              $metodoPago="Efectivo";
          }
          $datos = array("id_vendedor" => $_POST["idVendedor"],
            ...
            "fecha" => $_POST["fecha"],
            "neto" => $_POST["subtotal"],
            "iva_producto"=>$_POST["nuevoTotalIva"],
            ...
            "UUID" => $_POST["UUID"],
            "cliente_provicional" => $_POST["cliente_provicional"],
    ...
    /* =============================================
      ...
      static public function ctrRangoFechasVentasProductoI($fechaInicial
        , $fechaFinal
        ,$codigo
        , $tipoDocumentoE
        , $tipoDocumentoC
        ...
        $respuesta = ModeloVentas::mdlRangoFechasVentasProductoI($tabla
            , $fechaInicial
            , $fechaFinal
            ,$codigo
             , $tipoDocumentoE
